...
| I11 | `tools.runs.complete` 状态机 guard (类 2 L11) | ~~旧 `complete --status` 可反复改终态~~ | 4 | **obsolete** 2026-06-02 audit:模块已在 clean-slate 重写中删除；当前外部收尾入口为 `tools.runs.mark` |

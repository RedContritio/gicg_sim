...
规则版本：`current-cards-2026-09-11-v1`。手工预期依据见 [规则清单](rules.md)。
...
| 佛跳墙 | FoodAndAmplification | I03/I10 | 非技能/自伤与跨回合语义 Q02 |
...
| 蝶鳞 | DieLinBurstTriggersOnce；DieLinHealingThreshold | I12；TestRoundEnd_蝶鳞_* | 后台印、致死追加目标 Q03 |
...
| 乘胜追击 | ChengShengFourthPaidOperation；DiceCostReduceRestrictedFirst（engine 包） | I01/I02/I06/I11 | 计数起点、多个减费内部顺序 Q01；调和专项尚缺 |
...
- 下一批应先裁定 Q01–Q03/Q05，并修复 Q04；其余专项按上表补充，之后
  再做随机对局、失败序列保存与最小化。

...
local card = declare_card("噬星魔鸦", { dices = { electro = 3 }, energy = 0 }, { battle_action = true, requires_char = "菲谢尔" })
local character = get_char("菲谢尔")
local skill = get_skill(character, "夜巡影翼")
local active = get_counter("噬星魔鸦_装备", Scope.Self)

-- cards/事件/甜甜花酿鸡.lua
-- source: data/cleaned/action/5475_甜甜花酿鸡.yaml
-- 字段对照 (强制锁定):
--   id=5475 sub_class=事件牌 cost={同色:0} (0 cost)
--   effect: 治疗目标角色 1 点
-- 饱腹 status 由 data/system/food.lua 统一处理 (每回合每角色 ≤1 食物)

local ref = declare_card("甜甜花酿鸡", { dices = {} }, { target = "own" })
